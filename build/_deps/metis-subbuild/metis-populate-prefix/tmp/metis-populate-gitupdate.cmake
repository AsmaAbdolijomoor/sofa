...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v5.1.0-ModernInstall"
  WORKING_DIRECTORY "C:/Users/abdol/Documents/GitHub/UpperAirwayMesh/sofa/build/_deps/metis-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "v5.1.0-ModernInstall")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v5.1.0-ModernInstall" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: v5.1.0-ModernInstall")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/v5.1.0-ModernInstall")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"v5.1.0-ModernInstall\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/abdol/Documents/GitHub/UpperAirwayMesh/sofa/build/_deps/metis-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/abdol/Documents/GitHub/UpperAirwayMesh/sofa/build/_deps/metis-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
